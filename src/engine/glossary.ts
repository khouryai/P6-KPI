...
export const GLOSSARY: Record<string, string> = {
  ...
  'Against plan': 'Achieved hours minus planned hours for this period. Positive means the period got through more than the baseline asked of it.',
  'Project complete': 'How far the whole job had got by the end of this period, with where it stood at the start underneath.',
  'Due finishes made': 'Activities the baseline had finishing inside this period, and how many of them actually finished.',
  'Earned per hour': 'Budget hours earned for each hour the team has booked. Below 1.00 means the work is costing more than it is worth.',
  'Factor now': 'Earned per hour booked over the last three active months. What the job is converting at today.',
  'Factor before': 'Earned per hour booked over the three active months before those. What the job was converting at, to read the direction from.',
  'Progress a month': 'How much of the whole job is being completed in an average active month, over the recent window.',
  'At this pace': 'Months left to finish if the recent rate of progress holds. Blank when nothing is moving, because no pace finishes nothing.',
