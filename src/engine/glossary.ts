...
export const GLOSSARY: Record<string, string> = {
  ...
  'Actual start': 'When the activity really began: your keyed date, or P6\u2019s actual start. Never a planned date. Editable on the Two-Week Log and on Test Progress \u2014 typing overrides P6, clearing hands the date back to it.',
